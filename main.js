(function ($) {
  ...
  //company logo slider
  var company_logo_slider = new Swiper(".comapny-slider .swiper-container", {
    slidePerView: 5,
    autoPlay: true,
    speed: 1500,
    loop: true,
  ...
  // product slider
  var product_slider_3g_2r = new Swiper(
    ".product-slider-3grids-2rows .swiper-container",
    {
      slidesPerView: 4,
      spaceBetween: 25,
      speed: 1500,
  ...
  var product_slider_3g_1r = new Swiper(
    ".product-slider-3grids-1rows .swiper-container",
    {
      slidesPerView: 4,
      spaceBetween: 25,
      speed: 1500,
